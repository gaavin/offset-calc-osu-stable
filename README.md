...
Pushes to `master` that change non-test Go source or modules publish a GitHub Release tagged `vYYYY-MM-DD-HHMMSS` (UTC commit time). Docs, assets, tests-only, and other non-binary paths are skipped. Tags and assets are never overwritten.
